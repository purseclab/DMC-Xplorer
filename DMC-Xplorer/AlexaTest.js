...
var globalRefreshTokens = [] //array of objects, one for each skill containing refresh token, client ID of skill and client secret of skill
...
async function main(tokens) {
  ...
  var endpointInc = 0;
  var totalDevices = [1, 10, 50, 100, 200];
  var names = [["Living Room", "Kitchen"]]
  var types = [["LIGHT", "TV"]]
  var manufacturers = ["Sample manufacturer"]
