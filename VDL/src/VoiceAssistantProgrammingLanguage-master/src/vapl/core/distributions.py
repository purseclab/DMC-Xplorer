...
from core.lazy_eval import (LazilyEvaluable,
    requiredProperties, needsLazyEvaluation, valueInContext, makeDelayedFunctionCall)
from core.utils import DefaultIdentityDict, argsToString, areEquivalent, cached, sqrt2
...
# since vapl does not allow control flow to depend on random variables.
allowedOperators = (
	'__neg__',
	'__pos__',
	'__abs__',
...
import core.type_support as type_support
