...
from core.distributions import (Samplable, RejectionException, needsSampling,
                                       distributionMethod)
from core.lazy_eval import valueInContext
from core.vectors import Vector, OrientedVector, VectorDistribution, VectorField
from core.geometry import _RotatedRectangle
from core.geometry import sin, cos, hypot, findMinMax, pointIsInCone, averageVectors
from core.geometry import headingOfSegment, triangulatePolygon, plotPolygon, polygonUnion
from core.type_support import toVector
from core.utils import cached, cached_property, areEquivalent
...
class Region(Samplable):
	...
	def containsObject(self, obj):
		"""Check if the `Region` contains an :obj:`~core.object_types.Object`.
	...
	def __contains__(self, thing):
		...
		from core.object_types import Object
...
class PointSetRegion(Region):
	...
	No :obj:`~core.object_types.Object` can be contained in a `PointSetRegion`,
	...
	Args:
		...
		orientation (:obj:`~core.vectors.VectorField`, optional): orientation for
		  the region
...
class GridRegion(PointSetRegion):
	...
	Args:
		...
		orientation (:obj:`~core.vectors.VectorField`, optional): orientation of region
	"""
