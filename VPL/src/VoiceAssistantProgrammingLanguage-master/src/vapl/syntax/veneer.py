__all__ = (
    ...
    'television','smartLock','fan','airPurifier','smartCamera','alexaSkill',
    'vacuumCleaner','microwave', 'refrigerators', 'washingMachine',
    # 'setup', 'smartDevice'
    # Specifiers
    # 'With',
...
from core.dynamics import (Behavior,Monitor, DynamicScenario, GuardViolation, PreconditionViolation, InvariantViolation,
...
from classes import va, light, setup, thermostat, timestamp, probDist,television,smartLock,fan,airPurifier,smartCamera,action,alexaSkill,vacuumCleaner,microwave,refrigerators,washingMachine
import numpy as np
### Internals
...
def assign(a, b):
    classes = (light,thermostat,television,smartLock,fan,airPurifier,smartCamera,vacuumCleaner,microwave,refrigerators,washingMachine)
    print("a,b", a, b)
...
def addAction(device, actionName, parameters, commandStructure):
    customAction.append(action(device,actionName, parameters, commandStructure))
