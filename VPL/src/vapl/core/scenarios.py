...
from core.external_params import ExternalSampler
from core.regions import EmptyRegion
from core.workspaces import Workspace
from core.vectors import Vector
from core.utils import areEquivalent
from core.errors import InvalidScenarioError
from core.dynamics import Behavior
from core.requirements import BoundRequirement

class Scene:
	"""Scene()

	A scene generated from a vapl scenario.

	Attributes:
		objects (tuple of :obj:`~core.object_types.Object`): All objects in the
		  scene. The ``ego`` object is first.
		egoObject (:obj:`~core.object_types.Object`): The ``ego`` object.
		params (dict): Dictionary mapping the name of each global parameter to its value.
		workspace (:obj:`~core.workspaces.Workspace`): Workspace for the scenario.
	"""
...
class Scenario:
	...
	A compiled vapl scenario, from which scenes can be sampled.
	"""
