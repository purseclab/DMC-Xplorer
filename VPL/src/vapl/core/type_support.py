"""Support for checking vapl types."""
...
from core.distributions import (Distribution, RejectionException, StarredDistribution,
                                       distributionFunction)
from core.lazy_eval import (DelayedArgument, valueInContext, requiredProperties,
                                   needsLazyEvaluation)
from core.vectors import Vector
from core.errors import RuntimeParseError, saveErrorLocation
from core.utils import get_type_origin, get_type_args
...
def isA(thing, ty):
	"""Does this evaluate to a member of the given vapl type?"""
...
def coerceToAny(thing, types, error):
	...
	from syntax.veneer import verbosePrint
