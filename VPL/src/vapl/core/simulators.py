...
"""Interface between vapl and simulators."""

import types
from collections import OrderedDict

from core.object_types import (enableDynamicProxyFor, setDynamicProxyFor,
                                      disableDynamicProxyFor)
from core.distributions import RejectionException
...
class Simulator:
    """A simulator which can import/execute scenes from """
...
class Simulation:
    ...
    def run(self, maxSteps):
        ...
        try:
            ...
            while maxSteps is None or self.currentTime < maxSteps:
                ...
                # Run the simulation for a single step and read its state back into vapl
                self.step()
                self.updateObjects()
                self.currentTime += 1
    ...
    def updateObjects(self):
        ...
        for obj in self.objects:
            ...
            # Preserve some other properties which are assigned internally by vapl
